...
def _create_exp_directory(exp_dir_name, save_model_dir):
    expriment_dir = os.path.join(save_model_dir, exp_dir_name)
    if not os.path.exists(expriment_dir):
...
class Solver(object):
    ...
    def __init__(self, 
        ...
        _create_exp_directory(self.exp_dir_name, save_model_dir)
        self.use_last_checkpoint = use_last_checkpoint
        self.checkpoint_path = os.path.join(save_model_dir, exp_dir_name, CHECKPOINT_FILE_NAME)
        self.start_epoch = 1
